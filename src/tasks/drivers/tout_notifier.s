...
initialize:
.LFB0:
	.file 1 "src/tasks/drivers/tout_notifier.c"
	.loc 1 12 0
	.cfi_startproc
...
.LFE1:
	...
	.align	2
.LC0:
	.ascii	"tout_notifier\000"
	.align	2
.LC1:
	.ascii	"Service %s created with tid %d.\012\015\000"
	.text
	.align	2
	.global	tout_notifier
	.syntax unified
	.arm
	.fpu softvfp
	.type	tout_notifier, %function
tout_notifier:
.LFB2:
	.loc 1 55 0
	.cfi_startproc
...
.L13:
	...
	.cfi_endproc
.LFE2:
	.size	tout_notifier, .-tout_notifier
.Letext0:
...
.LASF82:
	.ascii	"src/tasks/drivers/tout_notifier.c\000"
.LASF27:
