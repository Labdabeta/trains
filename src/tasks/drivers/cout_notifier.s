...
initialize:
.LFB0:
	.file 1 "src/tasks/drivers/cout_notifier.c"
	.loc 1 10 0
	.cfi_startproc
...
.LFE1:
	...
	.align	2
.LC0:
	.ascii	"cout_notifier\000"
	.align	2
.LC1:
	.ascii	"Service %s created with tid %d.\012\015\000"
	.text
	.align	2
	.global	cout_notifier
	.syntax unified
	.arm
	.fpu softvfp
	.type	cout_notifier, %function
cout_notifier:
.LFB2:
	.loc 1 30 0
	.cfi_startproc
...
.L7:
	...
	.cfi_endproc
.LFE2:
	.size	cout_notifier, .-cout_notifier
.Letext0:
...
.LASF80:
	.ascii	"src/tasks/drivers/cout_notifier.c\000"
.LASF71:
	.ascii	"ctrl\000"
.LASF76:
	.ascii	"parent\000"
