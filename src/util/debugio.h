...
#ifdef DEBUG_MODE
#define DEBUG_DUMP_VAL(val) do { debugio_putstr(__FILE__ "@"); debugio_putstr(__func__); debugio_putc(':'); debugio_putint_decimal(__LINE__); debugio_putstr("\t" #val ": "); debugio_putint_decimal((int)(val)); debugio_putstr("\n\r"); } while (0)
#define DEBUG_DUMP_UVAL(val) do { debugio_putstr(__FILE__ "@"); debugio_putstr(__func__); debugio_putc(':'); debugio_putint_decimal(__LINE__); debugio_putstr("\t" #val ": "); debugio_putuint_decimal((unsigned int)(val)); debugio_putstr("\n\r"); } while (0)
