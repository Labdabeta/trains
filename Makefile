...
CFLAGS=-c -fPIC -Wall $(CPU) -msoft-float -DEXIT_SUCCESS=0 -DEXIT_FAILURE=1 -Dever=";;" -nostdlib -Isrc -Isrc/util/ -Isrc/tasks/ -Isrc/tasks/A0 -Isrc/tasks/drivers $(GIT_STUFF) -DTRACK_$(TRACK)
